...
* Check the [Forumoji website](https://lopste.github.io/forumoji) to make sure the emoji has not been contributed already, or the [missing emoji list](https://lopste.github.io/forumoji/missing-emojis.html) for a list of emojis that still need to be made.
